    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 overflow-x-hidden pt-16">
      ...
      <main className="flex-1">
        ...
        <section className="relative px-6 py-24 md:py-32 flex flex-col items-center text-center overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-b from-cream via-cream/50 to-background -z-10" />
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground mb-6 leading-tight">
              The AI that <span className="text-primary italic">loves</span> to remember.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="xl" className="h-16 px-10 text-xl font-bold rounded-4xl shadow-2xl shadow-primary/30 group" asChild>
                <Link href="/">
                  Chat with Cutuu <ArrowRight className="ml-2 w-6 h-6 group-hover:translate-x-1 transition-transform" />
                </Link>
              </Button>
